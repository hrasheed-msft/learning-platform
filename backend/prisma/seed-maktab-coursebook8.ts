...
`.trim();
  ...
  const flashcardData = [
    { unitId: unit1.id, front: 'Tahájjud', back: 'Voluntary night prayer in the last third of the night; minimum 2 rak\'at. Among the most virtuous nawāfil.' },
    { unitId: unit1.id, front: 'Khushū\'', back: 'Humility and full presence of heart during prayer. Developed by knowing the meanings of words, minimising distractions, and imagining it is one\'s last prayer.' },
    { unitId: unit2.id, front: 'Mahr', back: 'The mandatory gift (money or property) given exclusively to the bride by the groom as a condition of valid nikāḥ.' },
    { unitId: unit2.id, front: '\'Iddah', back: 'The mandatory waiting period after divorce or widowhood before a woman may remarry. Protects lineage and allows for reconciliation.' },
    { unitId: unit3.id, front: 'Ribā', back: 'Interest or usury: any predetermined additional amount on a loan. Prohibited in Qur\'an 2:275. Two types: ribā al-faḍl and ribā al-nasī\'ah.' },
    { unitId: unit3.id, front: 'Maysir', back: 'Gambling: wagering something of value on an uncertain outcome. Prohibited in Qur\'an 5:90 alongside alcohol.' },
    { unitId: unit3.id, front: 'Ijārah', back: 'An Islamic hire or lease contract where one party uses an asset owned by another in exchange for agreed rental payments.' },
    { unitId: unit6.id, front: 'Shamā\'il', back: 'The noble physical and moral characteristics of the Prophet Muḥammad ﷺ. Imām Tirmidhī compiled a famous collection of them.' },
    { unitId: unit7.id, front: 'Dhū al-Nūrayn', back: "\'He of the Two Lights\' — title of \'Uthmān ibn \'Affān, who married two daughters of the Prophet ﷺ: Ruqayyah and Umm Kulthūm." },
    { unitId: unit7.id, front: 'Muṣḥaf \'Uthmānī', back: 'The standardised written copy of the Qur\'an commissioned by \'Uthmān to unify all variant dialect copies. The basis of all Qur\'anic texts today.' },
    { unitId: unit8.id, front: 'Karram Allāhu wajhah', back: 'Title of \'Alī ibn Abī Ṭālib: "May Allāh honour his face" — because he never prostrated to an idol, having grown up in the Prophet\'s household.' },
    { unitId: unit11.id, front: 'Fatḥ al-QuṣṬantiniyyah', back: 'The Conquest of Constantinople (1453 CE) by Sultan Muḥammad al-Fātiḥ at age 21, fulfilling the Prophet\'s ﷺ prophecy about the city and its commander.' },
    { unitId: unit12.id, front: 'Qidam', back: 'An essential attribute of Allāh: pre-eternity / having no beginning. Allāh always was, without a starting point.' },
    { unitId: unit12.id, front: 'Baqā\'', back: 'An essential attribute of Allāh: everlastingness / having no end. Allāh always will be.' },
    { unitId: unit12.id, front: 'Qiyām binafsih', back: 'An essential attribute of Allāh: self-subsistence. Allāh depends on nothing and no one; everything depends on Him.' },
    { unitId: unit12.id, front: 'Mukhālafah lil-ḥawādith', back: "Allāh\'s distinctness from creation: He does not resemble anything He created. \"There is nothing like Him.\" (Qur\'an 42:11)" },
    { unitId: unit12.id, front: 'Istiwā\' / Bilā kayf', back: "Allāh\'s attribute of rising over the Throne. Ahl al-Sunnah affirm it as stated in Qur\'an 20:5 but without specifying the manner (bilā kayf)." },
    { unitId: unit13.id, front: 'Taṣdīq', back: "The first component of Īmān: sincere inner belief in the heart. Believing Allāh, His angels, books, messengers, Last Day, and divine decree." },
    { unitId: unit14.id, front: 'Nadam', back: 'The first condition of tawbah: sincere regret for the sin — feeling genuinely sorry because it displeased Allāh, not merely for its consequences.' },
    { unitId: unit14.id, front: 'Tawakkul', back: "Reliance on Allāh AFTER taking all available means. Not fatalism. The Prophet\'s ﷺ teaching: \"Tie your camel, then trust in Allāh.\" (Tirmidhī)" },
    { unitId: unit14.id, front: 'Taqwā', back: "Literally \"a shield\" — shielding oneself from Allāh\'s displeasure. Three levels: avoiding ḥarām, avoiding makrūh, and avoiding everything that distracts from Allāh." },
    { unitId: unit10.id, front: "Ṣalāḥuddīn al-Ayyūbī", back: 'Muslim Kurdish leader (1137–1193 CE) who united the Muslim world and reconquered Jerusalem (1187) without massacre. Known for justice, generosity, and nobility.' },
    { unitId: unit2.id, front: 'Waliīmah', back: "The post-nikāḥ wedding feast. A confirmed sunnah. The Prophet ﷺ said: \"Have a walīmah even with a single sheep.\" Attending when invited is a right of the Muslim." },
    { unitId: unit15.id, front: "Ḥifẓ al-Baṣar", back: 'Lowering/guarding the gaze. Commanded for both men and women in Qur\'an 24:30–31. The Prophet ﷺ called the unlawful gaze "the adultery of the eyes."' },
    { unitId: unit9.id, front: "Innī massaniya al-ḏurru", back: "Ayyūb\'s Qur\'anic du\'a\': \"Indeed adversity has touched me, and You are the Most Merciful of the merciful.\" (21:83) — Model supplication in times of trial." },
  ];

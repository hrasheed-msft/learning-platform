...
export async function seedMaktabCoursebook7() {
  ...
  const existing = await prisma.course.findFirst({
    where: { title: 'Maktab Coursebook 7' },
  });
  if (existing) {
    console.log('⏭️  Maktab Coursebook 7 already exists — skipping.');
    return;
  }
  ...
  const unitFiqh = await prisma.unit.create({
    data: {
      ...
      description:
        'Covers makrūhāt of ṣalāh, sutrah, sajdah tilāwah, ṣalātul kusūf/khusūf, taḥarrī, qaṣr ṣalāh, ṣalātul marīḍ, ṣalātul ma\'dhūr, zakāh, inheritance, i\'tikāf, laylatul qadr, ḥalāl foods, and uḍḥiyah.',
      orderIndex: 0,
      content: `
...
<p>Animal sacrifice offered during the days of Ḥajj (10th-12th Dhul Ḥijjah). Wājib upon every mature Muslim who owns the niṣāb amount and is not a traveller. Eligible animals: sheep (1yr+), goats (1yr+), cattle (2yr+), camels (5yr+). Cattle/camels have seven shares. Meat divided into thirds: self, relatives/neighbours, the poor.</p>
  ...
  const unitAhadith = await prisma.unit.create({
    data: {
      ...
      description:
        'Key aḥādīth on the people of Jannah and Jahannam, ghībah (backbiting), the miswāk, food etiquette, modesty, forgiveness of sins, lies, blessings, Laylatul Qadr, ṣalāt \'alan nabiy, the evil of stopping others from evil, ṣalāh with jamā\'ah, du\'ā\', and dhikr.',
      orderIndex: 1,
      content: `
...
<p>'Umar رضي الله عنه was stabbed by Abū Lu'lu'ah, a Persian slave, while leading the Fajr prayer. He passed away three days later. He was buried beside the Prophet ﷺ and Abū Bakr رضي الله عنه in the chamber of 'Ā'ishah رضي الله عنها. His khilāfah lasted ten years and six months.</p>
  ...
  const unitTarikh = await prisma.unit.create({
    data: {
      ...
      description:
        'The story of Zakariyyā عليه السلام and Maryam عليها السلام, the birth and piety of Yaḥyā عليه السلام, and the rise, contributions, and fall of the Abbasid Khilāfah (750–1258 CE).',
      orderIndex: 3,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>The Abbasid Khilāfah fell in <strong>1258 CE</strong> when the Mongol army, led by Hulagu Khan, invaded and sacked Baghdad. Libraries were destroyed and scholars were killed, marking the end of this great era of Islamic civilisation.</p>
  ...
  const unitAqaid = await prisma.unit.create({
    data: {
      ...
      description:
        'The concepts of qaḍā\' (divine foreknowledge) and qadr (divine decree), the evil eye and protection from it, the world as a place of means (asbāb), the journey of the soul, the life of barzakh, the Day of Judgement (blowing of the trumpet, resurrection, assembling, book of deeds, the scales).',
      orderIndex: 4,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>A bridge is set over Jahannam that everyone must cross. Believers will cross it swiftly according to their deeds. Others will fall into the fire. May Allāh protect us.</p>
  ...
  const unitAkhlaq = await prisma.unit.create({
    data: {
      ...
      description:
        'The danger of spreading rumours and verifying information, the value of time and using the five conditions before five others, the virtues of seeking knowledge, and the immense reward of sending ṣalāt \'alan nabiy (durūd) upon the Prophet ﷺ.',
      orderIndex: 5,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>Friday is especially virtuous for sending durūd. The Prophet ﷺ said: <em>"The best of your days is Friday, so send abundant blessings upon me on that day."</em> (Abū Dāwūd)</p>
  ...
  const unitAdab = await prisma.unit.create({
    data: {
      ...
      description:
        'The five branches of Islām, the seriousness of swearing by Allāh\'s name, etiquette of answering questions, using a mobile phone, speech, the internet, walking with elders, serving elders, informing family of whereabouts, interaction with non-Muslims, expressing condolences, and the five rights of a Muslim.',
      orderIndex: 6,
      content: `
<h2>Learning Objectives</h2>
<ul>

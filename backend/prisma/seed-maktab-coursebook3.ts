...
export async function seedMaktabCoursebook3() {
  ...
  if (existing) {
    console.log('⏭️  Maktab Coursebook 3 already exists — skipping.');
    return;
  }
  ...
  const unitFiqh = await prisma.unit.create({
    data: {
      ...
      description:
        'Learn the key terms of fiqh, types of najāsah (impurity), the farā\'iḍ and sunan of ghusl, the conditions and method of ṣalāh, and special prayers including Witr, Qaṣr and Ṣalātul Marīḍ.',
      orderIndex: 0,
      content: `
...
<ul>
  ...
  const unitAhadith = await prisma.unit.create({
    data: {
      ...
      description:
        'Ten key aḥādīth covering ṣalāh, love for others, steadfastness, life as a journey, this world, du\'ā\', honouring guests, mercy, modesty, and shukr (gratitude).',
      orderIndex: 1,
      content: `
<h2>Learning Objectives</h2>
...
<p>Allāh has given us so many blessings — our health, our family, our food, our sight, our hearing. If we keep thanking Allāh by saying "Alḥamdulillāh," He will give us even more. Gratitude (shukr) is one of the greatest forms of worship.</p>
  ...
  const unitSirah = await prisma.unit.create({
    data: {
      ...
      description:
        'The hijrah to Abyssinia, Ḥamzah and \'Umar\'s acceptance of Islam, the boycott of Banū Hāshim, the Year of Sadness, the journey to Ṭā\'if, and the miraculous Night Journey and Ascension.',
      orderIndex: 2,
      content: `
<h2>Learning Objectives</h2>
...
<p>The next morning, when the Prophet ﷺ told the Quraysh about this miraculous journey, Abū Bakr immediately believed him, earning the title <strong>Aṣ-Ṣiddīq</strong> (The Most Truthful).</p>
  ...
  const unitTarikh = await prisma.unit.create({
    data: {
      ...
      description:
        'The life of Prophet Ibrāhīm عليه السلام: his youth among idol worshippers, breaking the idols, the fire, the debate with Namrūd, the search for truth, and the stories of Zamzam, the sacrifice of Ismā\'īl, and building the Ka\'bah.',
      orderIndex: 3,
      content: `
<h2>Learning Objectives</h2>
<p>In this unit, you will learn about:</p>
...
<p>Ibrāhīm عليه السلام is given the title <strong>Khalīlullāh</strong> — the Close Friend of Allāh. His story teaches us about complete trust in Allāh, unwavering obedience, and courage in standing for the truth.</p>
  ...
  const unitAqaid = await prisma.unit.create({
    data: {
      ...
      description:
        'Learn about the prophets and messengers sent by Allāh, the difference between a rasūl and a nabī, the 25 prophets mentioned in the Qur\'ān, and the minor and major signs of the Day of Judgement.',
      orderIndex: 4,
      content: `
<h2>Learning Objectives</h2>
<p>In this unit, you will learn about:</p>
...
<ol>
  ...
  const unitAkhlaq = await prisma.unit.create({
    data: {
      ...
      description:
        'Learn about thinking good of others, sharing, kindness to parents, speaking the truth, saying a good word or keeping silent, and the dangers of ghībah (backbiting).',
      orderIndex: 5,
      content: `
<h2>Learning Objectives</h2>
<p>In this unit, you will learn about:</p>
...
<p>Rasūlullāh ﷺ asked the Companions: <em>"Do you know who the bankrupt person is?"</em> They said: "The one who has no money." He said: <em>"The bankrupt person from my Ummah is the one who comes on the Day of Qiyāmah with ṣalāh, fasting, and zakāh, but he insulted this person, slandered that person, stole the wealth of another, shed the blood of another, and struck yet another. So his good deeds will be given to each of them. And if his good deeds run out before the score is settled, their sins will be thrown onto him, and he will be thrown into the Fire."</em> (Ṣaḥīḥ Muslim)</p>
  ...
  const unitAdab = await prisma.unit.create({
    data: {
      ...
      description:
        'Learn the Islamic etiquette of travelling, studying, reciting the Qur\'ān, walking, and visiting the masjid.',
      orderIndex: 6,
      content: `
<h2>Learning Objectives</h2>

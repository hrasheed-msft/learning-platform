...
export async function seedMaktabCoursebook1() {
  ...
  const existing = await prisma.course.findFirst({
    where: { title: 'Maktab Coursebook 1' },
  });
  if (existing) {
    console.log('⏭️  Maktab Coursebook 1 already exists — skipping.');
    return;
  }
  ...
  const unitFiqh = await prisma.unit.create({
    data: {
      ...
      description:
        'Learn the five pillars of Islam, the importance of cleanliness (ṭahārah), and the step-by-step method of wuḍū\' (ablution).',
      orderIndex: 0,
      content: `
...
<ol>
  ...
  const unitAhadith = await prisma.unit.create({
    data: {
      ...
      description:
        'Five key aḥādīth for young Muslims: feeding the hungry, helping others, doing things calmly, staying clean, and speaking the truth.',
      orderIndex: 1,
      content: `
...
<p><strong>The Story of 'Abdul Qādir:</strong> 'Abdul Qādir was a young boy who went to Baghdād to learn. His mum gave him money and told him, "My dear son, never lie!" One day robbers stopped the caravan. When they asked what he had, 'Abdul Qādir told them he had forty gold coins. The leader of the gang was so shocked by his truthfulness that he began crying and changed his ways. 'Abdul Qādir grew up to become a very great friend of Allāh.</p>
  ...
  const unitSirah = await prisma.unit.create({
    data: {
      ...
      description:
        'The childhood of Rasūlullāh ﷺ, his youth, his trustworthy character, and his marriage to Khadījah رضي الله عنها.',
      orderIndex: 2,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<table>
  ...
  const unitTarikh = await prisma.unit.create({
    data: {
      ...
      description:
        'The creation of Ādam عليه السلام, the jealousy of Shayṭān, and the story of Nūḥ عليه السلام and the great flood.',
      orderIndex: 3,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<ul>
  ...
  const unitAqaid = await prisma.unit.create({
    data: {
      ...
      description:
        'The seven articles of faith, Sūrah al-Ikhlāṣ, and the names of Allāh: Ar-Razzāq and Ar-Raḥmān.',
      orderIndex: 4,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p><strong>Ḥadīth:</strong> A woman was searching for her lost child. When she found him, she pressed him to her chest and nursed him. Rasūlullāh ﷺ asked: "Do you think this woman would ever throw her child in the fire?" They replied: "Never." He ﷺ said: <strong>"Allāh is more merciful to His servants than this lady to her son."</strong> (Ṣaḥīḥ al-Bukhārī)</p>
  ...
  const unitAkhlaq = await prisma.unit.create({
    data: {
      ...
      description:
        'Respect for elders, cleanliness, gentleness in speech, smiling, and beginning from the right — the Sunnah way.',
      orderIndex: 5,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<ul>
  ...
  const unitAdab = await prisma.unit.create({
    data: {
      ...
      description:
        'The Sunnah etiquette of eating, drinking, sleeping, waking up, and using the washroom.',
      orderIndex: 6,
      content: `
<h2>Learning Objectives</h2>
<ul>

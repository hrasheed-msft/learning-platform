  ...
  await prisma.question.createMany({
    data: [
      ...
      },
      {
        unitId: unit1.id,
        type: 'MULTIPLE_CHOICE',
        questionText: 'In the root ك-ت-ب (K-T-B), which position does the letter ت occupy?',
      ...
      },
      {
        unitId: unit1.id,
        type: 'TRUE_FALSE',
        questionText: 'Sarf is considered more important than Nahw (grammar) by classical scholars.',
  ...
  await prisma.question.createMany({
    data: [
      ...
      },
      {
        unitId: unit2.id,
        type: 'MULTIPLE_CHOICE',
        questionText: 'The verb أَنْزَلَ (to send down) is which form?',
      ...
      },
      {
        unitId: unit2.id,
        type: 'FILL_BLANK',
        questionText: 'Form III (فَاعَلَ) adds the letter ___ after the first radical.',
        correctAnswer: 'ا',
  ...
  await prisma.question.createMany({
    data: [
      ...
      },
      {
        unitId: unit4.id,
        type: 'FILL_BLANK',
        questionText: 'The present tense of وَعَدَ (to promise) is ___.',
  ...
  await prisma.question.createMany({
    data: [
      ...
      },
      {
        unitId: unit5.id,
        type: 'FILL_BLANK',
        questionText: 'The command form of قَالَ (to say) for أنتَ is ___.',
        correctAnswer: 'قُلْ',
      ...
      },
      {
        unitId: unit5.id,
        type: 'MULTIPLE_CHOICE',
        questionText: 'In the past tense of قَالَ, the middle و becomes ___ in the 3rd person masculine.',
  ...
  await prisma.question.createMany({
    data: [
      ...
      },
      {
        unitId: unit6.id,
        type: 'FILL_BLANK',
        questionText: 'The past tense of دَعَا (to call) for هو shows the final و changing to ___.',
        correctAnswer: 'ى',
    ...
    data: [
      {
        unitId: unit7.id,
        type: 'MULTIPLE_CHOICE',
        questionText: 'Lafeef Mafrūq verbs have weak letters in which positions?',
      ...
      },
      {
        unitId: unit7.id,
        type: 'MULTIPLE_CHOICE',
        questionText: 'The verb وَقَى follows rules of which TWO weak verb types?',
      ...
      },
      {
        unitId: unit7.id,
        type: 'FILL_BLANK',
        questionText: 'The command form of وَفَى for أنتَ is ___.',
        correctAnswer: 'فِ',

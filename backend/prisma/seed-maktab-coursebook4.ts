...
export async function seedMaktabCoursebook4() {
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-fiqh' } },
    create: {
      slug: 'maktab-4-fiqh',
      courseId: course.id,
      title: 'Fiqh — Masaḥ, Wājib Acts of Ṣalāh, Ṣawm & Tarāwīḥ',
      description: 'Rules of masaḥ on khuffayn and wounds, wājib acts of ṣalāh, sajdah as-sahw, fasting (ṣawm) including what breaks the fast, qaḍā\' and kaffārah, those excused from fasting, and Tarāwīḥ ṣalāh.',
      orderIndex: 0,
      content: `
...
<ul>
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-ahadith' } },
    create: {
      slug: 'maktab-4-ahadith',
      courseId: course.id,
      title: 'Aḥādīth — Charity, Character, Friendship, Trust, Dhikr & Du\'ā\'',
      description: 'Seven aḥādīth on the best charity, good character, the company we keep, the importance of trust, the keys to Paradise, the remembrance of Allāh, and the power of du\'ā\'.',
      orderIndex: 1,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>Du'ā' is the essence of worship. We should always turn to Allāh for our needs, big or small. He loves it when we ask Him.</p>
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-sirah' } },
    create: {
      slug: 'maktab-4-sirah',
      courseId: course.id,
      title: 'Sīrah — The Hijrah & Early Madīnah Period',
      description: 'The Pledges of \'Aqabah, the Hijrah to Madīnah, the building of the first masjid, Islamic brotherhood (Mu\'ākhāt), treaties with the Jewish tribes, and the Battles of Badr, Uḥud, and Aḥzāb.',
      orderIndex: 2,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>A combined army of <strong>10,000 enemy troops</strong> marched on Madīnah. <strong>Salmān al-Fārsī</strong> رضي الله عنه, who was from Persia where trenches were a known military tactic, suggested digging a trench (khandaq) around the vulnerable sides of Madīnah. The siege lasted approximately <strong>27 days</strong>. Allāh sent a fierce storm that scattered the enemy camps, extinguished their fires, and overturned their tents. The coalition army retreated in disarray.</p>
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-tarikh' } },
    create: {
      slug: 'maktab-4-tarikh',
      courseId: course.id,
      title: 'Tārīkh — The Story of Yūsuf عليه السلام',
      description: 'The complete story of Prophet Yūsuf عليه السلام: his dream, the jealousy of his brothers, the well, slavery in Egypt, prison, interpreting the king\'s dream, becoming guardian of the storehouses, and the reunion with his family.',
      orderIndex: 3,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<blockquote>"O my Lord! You have given me sovereignty and taught me the interpretation of events — Creator of the Heavens and the Earth, You are my Protector in this world and the Hereafter. Make me die as a Muslim and join me with the righteous." (Qur'ān 12:101)</blockquote>
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-aqaid' } },
    create: {
      slug: 'maktab-4-aqaid',
      courseId: course.id,
      title: 'Aqā\'id — Major Signs of Qiyāmah & the Day of Judgement',
      description: 'The major signs before the Day of Judgement: the Mahdī, the Dajjāl and protection against him, the descent of \'Īsā عليه السلام, Ya\'jūj & Ma\'jūj, the Beast, the rising of the sun from the West, the Smoke, the Trumpet, Qiyāmah, the Prophet\'s intercession, and the Bridge.',
      orderIndex: 4,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>A bridge will be set over Jahannam that everyone must cross. It is described as being thinner than a hair and sharper than a sword. Believers will have light to guide them. Some will cross like lightning, some like wind, some like fast horses, some will crawl, and some will fall into the Fire below.</p>
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-akhlaq' } },
    create: {
      slug: 'maktab-4-akhlaq',
      courseId: course.id,
      title: 'Akhlāq — Trust, Permission, Removing Harm & Good Neighbours',
      description: 'The importance of trust (amānah) with the story of the cave, seeking permission before entering, removing harm from the road as ṣadaqah, and being a good neighbour.',
      orderIndex: 5,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<p>The rights of neighbours include: not causing harm, being patient with their faults, sharing food, visiting them when ill, consoling them in grief, and congratulating them in their happiness.</p>
  ...
  // ──────────────────────────────────────────────
    ...
    where: { courseId_slug: { courseId: course.id, slug: 'maktab-4-adab' } },
    create: {
      slug: 'maktab-4-adab',
      courseId: course.id,
      title: 'Ādāb — Du\'ā\', Dressing, Guests, Gatherings & Istinjā\'',
      description: 'The etiquette of making du\'ā\', Islamic dress code including satr, manners of hosts and guests, conduct in gatherings, and the ādāb of istinjā\' (toilet etiquette).',
      orderIndex: 6,
      content: `
<h2>Learning Objectives</h2>
<ul>
...
<ol>
  ...
  // --- Fiqh Quizzes ---
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-fiqh-q1' },
      create: {
        externalId: 'maktab-4-fiqh-q1',
        unitId: unitFiqh.id,
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-fiqh-q2' },
      create: {
        externalId: 'maktab-4-fiqh-q2',
        unitId: unitFiqh.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-fiqh-q3' },
      create: {
        externalId: 'maktab-4-fiqh-q3',
        unitId: unitFiqh.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-fiqh-q4' },
      create: {
        externalId: 'maktab-4-fiqh-q4',
        unitId: unitFiqh.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-fiqh-q5' },
      create: {
        externalId: 'maktab-4-fiqh-q5',
        unitId: unitFiqh.id,
        type: 'FILL_BLANK',
  ...
  // --- Aḥādīth Quizzes ---
    await Promise.all([
    prisma.question.upsert({
      where: { externalId: 'maktab-4-ahadith-q1' },
      create: {
        externalId: 'maktab-4-ahadith-q1',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-ahadith-q2' },
      create: {
        externalId: 'maktab-4-ahadith-q2',
        unitId: unitAhadith.id,
        type: 'FILL_BLANK',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-ahadith-q3' },
      create: {
        externalId: 'maktab-4-ahadith-q3',
        unitId: unitAhadith.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-ahadith-q4' },
      create: {
        externalId: 'maktab-4-ahadith-q4',
        unitId: unitAhadith.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-ahadith-q5' },
      create: {
        externalId: 'maktab-4-ahadith-q5',
        unitId: unitAhadith.id,
        type: 'MULTIPLE_CHOICE',
  ...
  // --- Sīrah Quizzes ---
    await Promise.all([
    prisma.question.upsert({
      where: { externalId: 'maktab-4-sirah-q1' },
      create: {
        externalId: 'maktab-4-sirah-q1',
        unitId: unitSirah.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-sirah-q2' },
      create: {
        externalId: 'maktab-4-sirah-q2',
        unitId: unitSirah.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-sirah-q3' },
      create: {
        externalId: 'maktab-4-sirah-q3',
        unitId: unitSirah.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-sirah-q4' },
      create: {
        externalId: 'maktab-4-sirah-q4',
        unitId: unitSirah.id,
        type: 'FILL_BLANK',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-sirah-q5' },
      create: {
        externalId: 'maktab-4-sirah-q5',
        unitId: unitSirah.id,
        type: 'MULTIPLE_CHOICE',
  ...
  // --- Tārīkh Quizzes ---
    await Promise.all([
    prisma.question.upsert({
      where: { externalId: 'maktab-4-tarikh-q1' },
      create: {
        externalId: 'maktab-4-tarikh-q1',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-tarikh-q2' },
      create: {
        externalId: 'maktab-4-tarikh-q2',
        unitId: unitTarikh.id,
        type: 'FILL_BLANK',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-tarikh-q3' },
      create: {
        externalId: 'maktab-4-tarikh-q3',
        unitId: unitTarikh.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-tarikh-q4' },
      create: {
        externalId: 'maktab-4-tarikh-q4',
        unitId: unitTarikh.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-tarikh-q5' },
      create: {
        externalId: 'maktab-4-tarikh-q5',
        unitId: unitTarikh.id,
        type: 'MULTIPLE_CHOICE',
  ...
  // --- Aqā'id Quizzes ---
    await Promise.all([
    prisma.question.upsert({
      where: { externalId: 'maktab-4-aqaid-q1' },
      create: {
        externalId: 'maktab-4-aqaid-q1',
        unitId: unitAqaid.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-aqaid-q2' },
      create: {
        externalId: 'maktab-4-aqaid-q2',
        unitId: unitAqaid.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-aqaid-q3' },
      create: {
        externalId: 'maktab-4-aqaid-q3',
        unitId: unitAqaid.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-aqaid-q4' },
      create: {
        externalId: 'maktab-4-aqaid-q4',
        unitId: unitAqaid.id,
        type: 'FILL_BLANK',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-aqaid-q5' },
      create: {
        externalId: 'maktab-4-aqaid-q5',
        unitId: unitAqaid.id,
        type: 'MULTIPLE_CHOICE',
  ...
  // --- Akhlāq Quizzes ---
    await Promise.all([
    prisma.question.upsert({
      where: { externalId: 'maktab-4-akhlaq-q1' },
      create: {
        externalId: 'maktab-4-akhlaq-q1',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-akhlaq-q2' },
      create: {
        externalId: 'maktab-4-akhlaq-q2',
        unitId: unitAkhlaq.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-akhlaq-q3' },
      create: {
        externalId: 'maktab-4-akhlaq-q3',
        unitId: unitAkhlaq.id,
        type: 'FILL_BLANK',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-akhlaq-q4' },
      create: {
        externalId: 'maktab-4-akhlaq-q4',
        unitId: unitAkhlaq.id,
        type: 'MULTIPLE_CHOICE',
  ...
  // --- Ādāb Quizzes ---
    await Promise.all([
    prisma.question.upsert({
      where: { externalId: 'maktab-4-adab-q1' },
      create: {
        externalId: 'maktab-4-adab-q1',
        unitId: unitAdab.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-adab-q2' },
      create: {
        externalId: 'maktab-4-adab-q2',
        unitId: unitAdab.id,
        type: 'MULTIPLE_CHOICE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-adab-q3' },
      create: {
        externalId: 'maktab-4-adab-q3',
        unitId: unitAdab.id,
        type: 'TRUE_FALSE',
    ...
    prisma.question.upsert({
      where: { externalId: 'maktab-4-adab-q4' },
      create: {
        externalId: 'maktab-4-adab-q4',
        unitId: unitAdab.id,
        type: 'FILL_BLANK',
